import type { SortingAlgorithmMeta } from "@/features/sorting/engine/types";

type SortingEducationPanelProps = {
...
export function SortingEducationPanel({
  algorithm,
  stepTitle,
  stepDetail,
  activeLine,
}: SortingEducationPanelProps) {
  return (
