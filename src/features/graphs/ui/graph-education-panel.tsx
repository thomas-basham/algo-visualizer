import type { GraphAlgorithmMeta } from "@/features/graphs/engine/types";

type GraphEducationPanelProps = {
...
export function GraphEducationPanel({
  algorithm,
  stepTitle,
  stepDetail,
  activeLine,
}: GraphEducationPanelProps) {
  return (
